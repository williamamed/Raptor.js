		  ...
		  .forEach(function(file) {
			...
			for (var bundle in me.bundles) {
    			...
    			if(main.configure && me.on){
					...
					me.emit('before:module.config',bundle)
					main.configure(me)
					me.bundles[bundle].hooks.config('after').resolve(me)
					me.emit('after:module.config',bundle)
				}
    		}
	...
	*/
	...
	stackedComponents:function(){
		...
		for (var bundle in me.bundles) {
			var main=new me.bundles[bundle].main()
			if(main.middleware){
			    me.emit('before:module.middleware',bundle)
				me.bundles[bundle].hooks.middleware('before').resolve(me)
				main.middleware(me)
			}
			me.emit('after:module.middleware',bundle)
				...
				fs
				  ...
				  .forEach(function(file) {
				  	...
				  	if(typeof controller == 'function'){
				  		...
				  		R.emit('component:read-controller',claseES6,path.join(pathController,file),bundle)
