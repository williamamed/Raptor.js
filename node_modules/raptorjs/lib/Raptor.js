...
module.exports={
	...
	*/
	readConfig:function(){
		...
		this.language.config = this.options.language;
	...
	*/
	main:function(basepath){
		...
		express.response.send=function(body){
			this.__send(client.getContent(body,me,this))
		}
	...
	*/
	mainNodeBundle:function(mainClass,R,bundle){
		return function(request,response,next){
			R.addLanguages(bundle, request);
			request.lang=function(){
				request.language.getTranslation(arguments);
			}
	...
	* Raptor.js - Node framework
	*
	* Adiciona soporte para internacionalización a la petición
	*
	* @author Jorge Miralles
	* @param {object} bundle Configuracion del bundle
	* @param {object} req Objeto Request
	*/
	addLanguages:function(bundle,req){
		req.language =lodash.cloneDeep(this.language);
		req.language.init(this.bundles,bundle,req, this.basePath);
	...
	* 
	*/
	client:function(list,value,pos,object){
		if(list.length-1>pos){
			object[list[pos]]=this.recursiveOption(list,value,pos+1,object[list[pos]]);
			return object;
		}else{
