UIR.Controller('RUX.Home', {
    ...
    openFunction:function(frame,route){
        ...
        if(frame){
            ...
            UIR.getController('RUX.Home').getWindow().load(route, function(r, status, xhr) {
                ...
                if (xhr.status === 404 ) {
                    me.show404(UIR.getController('RUX.Home').getWindow())
                }
    ...
    show404:function(windowEmbed){
        windowEmbed.append('<h1 style="font-size:50px;margin-top:50px;padding:30px;color: #372b53;margin-bottom: 200px"><span style="font-size:70px">): </span> 404 Not Found</h1>')
    },
    onProfile: function() {
