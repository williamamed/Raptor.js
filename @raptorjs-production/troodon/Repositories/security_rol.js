...
module.exports={
	initRepo:function(){
		...
		this.belongsToMany(this.R.getModels('troodon').security_privilege,{through: 'security_rol_security_privilege',foreignKey: 'id_rol'}) 
		this.R.getModels('troodon').security_privilege.belongsToMany(this,{through: 'security_rol_security_privilege',foreignKey: 'id_privilege'})
	},
